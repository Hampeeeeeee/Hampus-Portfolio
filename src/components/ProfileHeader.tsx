...
export function ProfileHeader() {
  return (
    <>
      <div className="w-[640px] bg-transparent py-6 px-6 rounded-3xl shadow-[0_2px_4px_0_rgba(255,255,255,0.3)]">
        <div className="flex items-center space-x-6 border-b-2 border-blue-200 pb-2">
          ...
          <div>
            ...
            <p className="text-xl text-gray-500 mb-2">{profile.role}</p>
          </div>
        </div>
